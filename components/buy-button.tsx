  ...
  return (
    ...
    >
      ...
      <p className="text-xs mt-3 leading-relaxed" style={{ color: 'var(--text-muted, #9ca3af)' }}>
        {note ||
          'Physical Steelbook Edition ships October 15, 2026. Digital editions launch September 24 — with 48-hour early access from September 22 for the PS5 Digital Deluxe Edition only (PlayStation Store).'}
