...
The same Deluxe content on Xbox and PC does **not** include early access — that's a PlayStation-exclusive perk, so double-check the store page for your platform before buying. Full breakdown of both editions, what's included, and whether Deluxe is worth it is in our [pre-order guide](/games/control-resonant/preorder-guide).
